...
import { buildSmartOrderMatchingAuditReport, getOrderOptimizationWithDetails } from "@/lib/order-optimizations";
...
export async function GET(request: Request, context: RouteContext) {
  ...
  return jsonUtf8(buildSmartOrderMatchingAuditReport(optimization));
}
